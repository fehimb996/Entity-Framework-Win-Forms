...
namespace DataLayer
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<GetOrders_Result> GetOrders(string customerID, Nullable<int> employeeID, Nullable<System.DateTime> dateFrom, Nullable<System.DateTime> dateTo)
        {
            var customerIDParameter = customerID != null ?
                new ObjectParameter("CustomerID", customerID) :
                new ObjectParameter("CustomerID", typeof(string));
        ...
        public virtual ObjectResult<spSearchOrders2_Result> spSearchOrders2(Nullable<int> employeeID, string customerID, Nullable<int> productID)
        {
            var employeeIDParameter = employeeID.HasValue ?
                new ObjectParameter("EmployeeID", employeeID) :
                new ObjectParameter("EmployeeID", typeof(int));
        ...
        public virtual ObjectResult<spSearchOrders3_Result> spSearchOrders3(Nullable<int> employeeID, string customerID, Nullable<int> productID)
        {
            var employeeIDParameter = employeeID.HasValue ?
                new ObjectParameter("EmployeeID", employeeID) :
                new ObjectParameter("EmployeeID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spSearchOrders3_Result>("spSearchOrders3", employeeIDParameter, customerIDParameter, productIDParameter);
        }
    }
}
